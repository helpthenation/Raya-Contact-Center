...
class SurveyInvite(models.TransientModel):
    _name = 'assessment_test_invite'
    _description = 'Survey Invitation Wizard'

    assessment_id = fields.Many2one('assessment_center.assessment_center')
    @api.model
    ...
    attachment_ids = fields.Many2many(
        'ir.attachment', 'test_mail_compose_message_ir_attachments_rel', 'wizard_id', 'attachment_id',
        string='Attachments')
    ...
    partner_ids = fields.Many2many(
        'res.partner', 'assessment_test_invite_partner_ids', 'invite_id', 'partner_id', string='Recipients',
        domain="""[
    ...
    def _compute_survey_start_url(self):
        ...
        for invite in self:
            ...
            invite.survey_start_url += '?ass_id='+str(self.assessment_id.id)
    ...
    def action_invite(self):
        ...
        answers.assessment_id = self.assessment_id
