...
class SurveyInvite(models.TransientModel):
    ...
    attachment_ids = fields.Many2many(
        'ir.attachment', 'test_mail_compose_dropped_ir_attachments_rel', 'wizard_id', 'attachment_id',
        string='Attachments')
    ...
    partner_ids = fields.Many2many(
        'res.partner', 'dropped_survey_invite_partner_ids', 'invite_id', 'partner_id', string='Recipients',
        domain="""[
    ...
    def _compute_survey_start_url(self):
        ...
        for invite in self:
            ...
            invite.survey_start_url += '?app_id='+str(self.applicant_id.id)
    ...
    def action_invite(self):
        ...
        answers.applicant_id = self.applicant_id.id
